...
namespace project_ASP.NET
{
    ...
    partial void DeleteRental(Rental instance);
		...
		public DataClasses2DataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["RentMovieDBConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnSubscriptionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Age", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		public string Age
		{
			get
			{
